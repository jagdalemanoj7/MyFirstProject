...
/**
 * Search the Opportunity Using Start With Option With a Valid Character Name.
 * @author admin
 *
 */
public class SearchOpportunityByStartWithOptionWithValidCharacterNameTc_47 extends BaseClass {

	@Test
	public void SearchOpportunityByStartWithOptionWithValidCharacterNameTc_47Test() throws EncryptedDocumentException, FileNotFoundException, IOException {
		...
		*/
        ...
        /*  select opportunity name from dropdown list*/
			    String searchby = FileLib.getExcelData("Sheet1", 3, 2); 
	    ...
	    /*	select equals to option from another dropdown box*/		    
			    String searchcriteria = FileLib.getExcelData("Sheet1", 3, 3);
	    ...
	    /*  enter any valid name of opportunity related to into text box*/
			    String oppname = FileLib.getExcelData("Sheet1", 3, 4);
