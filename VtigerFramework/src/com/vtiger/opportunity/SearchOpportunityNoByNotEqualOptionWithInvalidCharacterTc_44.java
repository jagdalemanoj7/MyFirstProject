...
/**
 * Search the Opportunity No Using Not Equal Option With an Invalid Character.
 * @author admin
 *
 */
public class SearchOpportunityNoByNotEqualOptionWithInvalidCharacterTc_44 extends BaseClass{
	@Test
	public void SearchOpportunityNoByNotEqualOptionWithInvalidCharacterNameTc_44Test() { 
        ...
        /*  select opportunity name from dropdown list*/
			    ...
			    Reporter.log("Opportunity no selected from dropdown list succesfully..",true);
        ...
        /*  click on search now button*/
			    ...
			    Reporter.log("Search now button clicked..",true);			    			    			    			   			    			   
